...
/// Thin SVD with a caller-specified execution policy. Published under the bare
/// name [`expert::svd`](crate::expert::svd).
pub fn svd_with_policy<T, L, B>(
    backend: &B,
    t: &Tensor<L::Storage, L>,
    nrow: usize,
    policy: ExecPolicy,
...
/// Truncated SVD with a caller-specified execution policy. Published under the
/// bare name [`expert::trunc_svd`](crate::expert::trunc_svd).
pub fn trunc_svd_with_policy<T, L, B>(
    backend: &B,
    t: &Tensor<L::Storage, L>,
    nrow: usize,
    params: &TruncSvdParams,
...
/// Thin QR with a caller-specified execution policy. Published under the bare
/// name [`expert::qr`](crate::expert::qr).
pub fn qr_with_policy<T, L, B>(
    backend: &B,
    t: &Tensor<L::Storage, L>,
    nrow: usize,
    policy: ExecPolicy,
...
/// Thin LQ with a caller-specified execution policy. Published under the bare
/// name [`expert::lq`](crate::expert::lq).
pub fn lq_with_policy<T, L, B>(
    backend: &B,
    t: &Tensor<L::Storage, L>,
    nrow: usize,
    policy: ExecPolicy,
